...
import { GoodsReceivedNoteColumns, GoodsReceivedNoteDetailColumns } from "../../utils/PurchaseOrderColumns";
...
export default function GoodsReceivedNoteList() {
    ...
    return (
        <Page title="Goods Received Notes" className={'h-full'}>
            <div className="flex flex-col gap-1 h-full justify-between w-full p-2" >
                <div>
                    <h4><b>Purchase / Goods Received Notes</b></h4>
                </div>
                <JqxSplitter orientation="horizontal" width={'100%'} height={'100%'} className={'flex-1'}>
                    <div>
                        <JqxGrid columns={GoodsReceivedNoteColumns} sortable={true} width={'100%'} columnsresize={true}>
                        </JqxGrid>
                    </div>

                    <div>
                        <JqxGrid columns={GoodsReceivedNoteDetailColumns} sortable={true} width={'100%'} columnsresize={true}>
                        </JqxGrid>
                    </div>
                </JqxSplitter>
