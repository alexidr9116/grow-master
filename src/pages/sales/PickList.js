...
import { OrderColumns, OrderDetailColums } from "../../utils/SalesGridColumns";
...
export default function PickList() {
    ...
    return (
        <Page title="Pick List" className={'h-full'}>
            <div className="flex flex-col gap-1 h-full justify-between w-full p-2" >
                ...
                <div className="flex gap-2 p-2 justify-between flex-wrap">
                    ...
                    <JqxButton className={'flex-1'}>Cancle</JqxButton>
                    <JqxButton className={'flex-1'}>Copy</JqxButton>
                    <JqxButton className={'flex-1'}>Status</JqxButton>
                    <JqxButton className={'flex-1'}>Print</JqxButton>
                    <JqxButton className={'flex-1'}>PrintBack</JqxButton>
